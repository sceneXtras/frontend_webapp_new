...
// Adjusting the rule for unused variables to warn and ignore variables starting with an underscore
config.rules['@typescript-eslint/no-unused-vars'] = ['warn', { varsIgnorePattern: '^_' }];

// Disabling specific unicorn rules
